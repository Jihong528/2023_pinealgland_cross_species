...
option_list <- list(
  ...
  make_option(c("--min_pct_cell"), type = "integer", default = 0.1,
              action = "store", help = "This is min_pct_cell used in wilcox test."
...
opt = parse_args(OptionParser(option_list = option_list,
                              usage = "This Script is used to find DEGs by wilcox test!"))
print(opt)
...
FindDEGsFromWilcoxtest(exp_count.seurat = exp_count.seurat,
