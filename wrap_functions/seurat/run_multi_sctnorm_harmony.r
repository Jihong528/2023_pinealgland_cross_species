...
exp_count.seurat <- SCTransform(exp_count.seurat, vars.to.regress = c("percent.rb", "percent.mt"), variable.features.n = opt$nfeatures,
																verbose = FALSE)

# Eliminate batch effects with harmony and cell classification
DefaultAssay(exp_count.seurat) <- "SCT"
